...
public class MainActivity extends AppCompatActivity implements FrameProcessor {
    ...
    private void detectFaces(List<FirebaseVisionFace> firebaseVisionFaces, Bitmap bitmap) {
        ...
        faceTextPaint.setColor(getResources().getColor(R.color.boxColor));
        faceTextPaint.setTextSize(30f);
        faceTextPaint.setTypeface(getResources().getFont(R.font.montserrat_bold));

        Paint landmarkPaint = new Paint();
        landmarkPaint.setColor(getResources().getColor(R.color.pointColor));
        landmarkPaint.setStyle(Paint.Style.FILL);
        landmarkPaint.setStrokeWidth(7f);

        Paint smileStroke = new Paint();
        landmarkPaint.setColor(getResources().getColor(R.color.smileColor));
        landmarkPaint.setStyle(Paint.Style.FILL);
        landmarkPaint.setStrokeWidth(7f);

        Paint eyeStroke = new Paint();
        landmarkPaint.setColor(getResources().getColor(R.color.smileColor));
        landmarkPaint.setStyle(Paint.Style.FILL);
        landmarkPaint.setStrokeWidth(7f);
        ...
        for (int i = 0; i < firebaseVisionFaces.size(); i++) {
            ...
            canvas.drawText("Face " + i, (firebaseVisionFaces.get(i).getBoundingBox().centerX() - (firebaseVisionFaces.get(i).getBoundingBox().width() >> 2) + 8f), // added >> to avoid errors when dividing with "/"
            ...
            if (face.getLandmark(FirebaseVisionFaceLandmark.MOUTH_LEFT) != null
                ...
                canvas.drawLine(bottomMouth.getPosition().getX(),
                        ...
                        rightMouth.getPosition().getY(), smileStroke);
            }
